...
public class EmailUtil {
    ...
    private static final String FROM_EMAIL = "thegrinderystore@gmail.com";
    private static final String FROM_PASSWORD = "your-app-password"; // điền app password của gmail ở đây nha
