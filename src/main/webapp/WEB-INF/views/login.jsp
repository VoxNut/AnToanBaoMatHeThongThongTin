...
<div class="container">
    <div class="auth-container">
        ...
        <button type="button" id="googleSignInBtn" class="btn-google" onclick="signInWithGoogle()">
            ...
            <span id="googleBtnText"><fmt:message key="login.google" /></span>
        </button>

        <div class="divider">
            <span><fmt:message key="login.divider" /></span>
        </div>
        ...
        <form method="POST" action="${pageContext.request.contextPath}/login">
            ...
            <button type="submit" class="btn btn-primary" style="width: 100%;"><fmt:message key="login.submit" /></button>
        </form>

        <div class="links">
            <fmt:message key="login.no_account" /> <a href="${pageContext.request.contextPath}/register"><fmt:message key="login.register_link" /></a>
        </div>
    </div>
</div>
...
<script>
    ...
    function signInWithGoogle() {
        ...
        firebase.auth().signInWithPopup(provider)
            ...
            .catch(error => {
                btn.disabled = false;
                btnText.textContent = '<fmt:message key="login.google" />';
